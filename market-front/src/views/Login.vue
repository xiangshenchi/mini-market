...
import { userRegisterService, userLoginService } from '@/api/user.js'; // 导入用户服务
import { useTokenStore } from '@/stores/token.js'; // Pinia
    ...
    methods: {
        ...
        async login() {
            try {
                ...
                const tokenStore = useTokenStore(); // 没有直接的 import 语法
